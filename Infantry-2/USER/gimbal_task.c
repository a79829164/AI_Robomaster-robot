...
float yaw_locationPID_input , yaw_locationPID_input_updateFlag = 1;
...
int fixed_bullet_speedshoot_once = 1;
...
void gimbal_task(void)
{
	...
	{	
		Yaw_Motor_encoding = Yaw_Motor_encoding + 8192;
	}
...
void remote_gimbal_control_mode()
{
	...
	if(yaw_locationPID_input >= 2 * Yaw_motorloco_init - 5750)  
	{
		yaw_locationPID_input = 2 * Yaw_motorloco_init - 5750;
	}
	if(yaw_locationPID_input <= 5750)  
	{
		yaw_locationPID_input = 5750;
	}

	gimbal_speed_yaw_set   =  PID_Calc(&yawmotor_remote         , Yaw_Motor_encoding       , yaw_locationPID_input);   

	gimbal_speed_pitch_set =  PID_Calc(&pitchmotor_remote       , Pitch_Motor[0]     , pitch_angle_set + Pitch_motorloco_init - 200); // 1910   
...
void automatic_gimbal_mode6()
{
	...
	Trigger_Motor_Set = 800;
//	if(fixed_bullet_speedshoot_once)
//	{
//    Trigger_Motor_Set = fixed_bullet_speedset;
//		fixed_bullet_speedshoot_once = 0;
//	}
//	
	from_realsense_angle_flag = 1;
